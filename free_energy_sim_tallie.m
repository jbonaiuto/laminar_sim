...
if params.nsims==0
    out_path=fullfile('D:\layer_sim\results',subj_info.subj_id,num2str(session_num),'allverts');
end
...
if params.nsims>0
    ...
    simvertind=[1:nverts];
    Npatch=100;
    patchvertind=randperm(nverts);
    Ip=patchvertind(1:Npatch)
end
% Save priors
...
%allcrossF=zeros(Nmesh,Nsim,Nmesh,Nmeth,Nfolds);
