...
% Output directory
out_path=fullfile('d:/layer_sim/results_real_noise2',subj_info.subj_id,num2str(session_num));
...
if length(params.out_file)==0
    params.out_file=sprintf('allcrossF_f%d_%d_dipolemoment%d.mat',invfoi(1),invfoi(2),dipole_moment);
end
...
for simmeshind=1:Nmesh, %% choose mesh to simulate on
    ...
    for s=1:Nsim,
        ...
        matlabbatch{1}.spm.meeg.source.simulate.isSNR.noiseFile = {'C:\layer_sim\gb070167_sofienormative_20150506_04.ds\bepdspmeeg_gb070167_sofienormative_20150506_04.mat'};
