...
%
% Use as
%   simlayer_free_energy_absolute(subjects(1), 1, [10 30], 20, 100)
...
% 
%   simlayer_free_energy_absolute(...,'param','value','param','value'...) allows
...
defaults = struct('surf_dir', 'd:\pred_coding\surf', 'mri_dir', 'd:\pred_coding\mri',...
    'out_file', '', 'sim_patch_size', 5, 'reconstruct_patch_size', 5, 'nsims', 60);  %define default values
...
% Output directory
out_path=fullfile('d:/layer_sim/results_abs',subj_info.subj_id,num2str(session_num));
...
if length(params.out_file)==0
    params.out_file=sprintf('allcrossF_f%d_%d_dipolemoment%d_noise%d.mat',...
        invfoi(1),invfoi(2),dipole_moment,white_noise);
end
