...
if length(params.out_path)==0
    params.out_path=fullfile('d:/layer_sim/ttest_results_real_noise2',subj_info.subj_id,...
        num2str(session_num),sprintf('f%d_%d_dipolemoment%d',invfoi(1),...
        invfoi(2),dipole_moment));
end
